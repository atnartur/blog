...
Хотя сейчас присутствуют множество сервисов для хранения и синхронизации файлов в облаке (например, [Яндекс.Диск](http://ru.atnartur.dev/r/ydisk) или [Dropbox](http://ru.atnartur.dev/r/drop)), случаются ситуации, когда данные решения для синхронизации не подходят. <!--more-->
